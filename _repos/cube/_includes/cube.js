...
CUBE.view = function (spec) {
    ...
    var ROTATE_X = [90, 0, 0, 0, 0, -90],
        ...
        get_side_el = function (i) {
            var sideEl = spec.datasource.el_for_side(i),
                z = spec.datasource.side_length() / 2;

            sideEl.style.position = 'absolute';
            sideEl.style.width = spec.datasource.side_length() + 'px';
            sideEl.style.height = spec.datasource.side_length() + 'px';
            sideEl.style.opacity = spec.datasource.opacity_for_side(i);
            sideEl.style.webkitTransform = 'rotateX(' + ROTATE_X[i] + 'deg) rotateY(' + ROTATE_Y[i] + 'deg) translateZ(' + z + 'px)';
            sideEl.dataset.side = i;
            sideEl.addEventListener('load', spec.delegate.did_load_side(i));
            return sideEl;
        },
        ...
        get_background_image_el = function () {
            ...
            imageEl.src = spec.datasource.image_url_for_background();
            imageEl.style.width = '100%';
            imageEl.style.height = 'auto';
            imageEl.style.position = 'absolute';
            imageEl.style.opacity = spec.datasource.opacity_for_background();
